...
sys.path.insert(0, '/home/user/repos/models/research')
from object_detection.utils import dataset_util

# the labels in your dataset in correct order
ValidLabels = ["shirt", "car", "cow", "buddha", "beer"]

# the directory containing all the images and respective .txt files
DatasetDirectory = "/home/user/directorywithalltheimagesandlabels/"  # MUST end with '/'
# the directory in which you want the .record to be saved
OutputDirectory = "/home/user/outputdirectory/"  # MUST end with '/'
# the desired filename of the .record file
Output_filename = "tf_record_train.record"
